...
2. Скачайте архив (zip/rar) со [страницы последнего релиза](https://github.com/Flowseal/zapret-fork-fteam/releases/latest)
...
## ВНИМАНИЕ ПОМЕТКА
Это всего лишь форк оригинального проекта.
Все инструкции и лицензия предоставленая тут принадлежат автору - https://github.com/Flowseal/zapret-discord-youtube/
Ссылка на релизы в README была изменена на ссылку релизов данного форка.
